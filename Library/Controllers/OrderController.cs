...
namespace Library.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(IBookService bookService, IAutorService autorService, ITypeService typeService, IGenreService genreService, IPHService phService)
        {
        ...
        public ActionResult OrderConfirmUser(int bookId, int userId)
        {
            int copyId = BookService.GetFreeCopyId(bookId);
            OrderDTO orderDTO = new OrderDTO { UserId = userId, CopyId = copyId };
            BookService.CreateOrder(orderDTO);
